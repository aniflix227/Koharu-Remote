  ...
  return (
    <div className='space-y-4'>
      ...
      <div className='space-y-1.5 pt-4 border-t border-border'>
        <Label className='text-xs'>Remote AI Backend URL (Google Colab)</Label>
        <Input
          type='url'
          value={pipeline.remote_ai_url ?? ''}
          onChange={(e) => onChange({ ...pipeline, remote_ai_url: e.target.value })}
          placeholder='https://your-tunnel.trycloudflare.com'
        />
        <p className='text-[10px] text-muted-foreground'>
          If you are using Remote AI for Detection, OCR, or Inpainting, paste the Cloudflare Tunnel URL here.
        </p>
      </div>
    </div>
  )
